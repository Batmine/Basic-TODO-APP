...
function App() {
  ...
  const addATodo = (event) => {
    ...
    setTodos([...todos, inputText]); // Trick spread operator, we set the Todos and keep everything to an array (array is just a list), and whatever I put in the inputText it's gonna push it in the array
